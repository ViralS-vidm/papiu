...
@section('title') {{ __('core::labels.create') . ' ' . __('product::labels.product') }} @endsection
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        ...
        @slot('li_2') {{ __('core::labels.create') . ' ' . __('product::labels.product') }} @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">{{ __('core::labels.create_new') . ' ' . __('product::labels.product') }}</h4>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-lg-10">
                            <button type="submit"
                                    class="btn btn-primary">{{ __('core::labels.create') . ' ' . __('product::labels.product') }}</button>
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
