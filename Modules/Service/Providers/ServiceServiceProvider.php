...
use Modules\Service\Repositories\OfferRepository;
use Modules\Service\Repositories\ServiceItemRepository;
use Modules\Service\Repositories\ServiceRepository;
use Modules\Service\Services\Contracts\OfferServiceInterface;
use Modules\Service\Services\OfferService;
...
class ServiceServiceProvider extends ServiceProvider
{
    ...
    public $bindings = [
        ...
        ServiceItemRepositoryInterface::class => ServiceItemRepository::class,
        OfferRepositoryInterface::class => OfferRepository::class,
        OfferServiceInterface::class => OfferService::class
    ];
