...
use Modules\Booking\Repositories\OfferRequestRepository;
use Modules\Booking\Repositories\ServiceRequestRepository;
...
class BookingServiceProvider extends ServiceProvider
{
    ...
    public $bindings = [
        ...
        OfferRequestRepositoryInterface::class   => OfferRequestRepository::class,
        ServiceRequestRepositoryInterface::class => ServiceRequestRepository::class,
    ];
